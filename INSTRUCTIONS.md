...
- **`layout.tsx`**: The root layout that defines the consistent UI structure (fonts, metadata) and wraps the app with providers.
...
- **`supabase.ts`**: Configuration and initialization of the Supabase client for evidence persistence.
